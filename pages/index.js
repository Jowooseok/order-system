...
const home = () => {
    ...
    const appointOk = () => {
        ...
        if (address !== null) {
            if (window.postAddres && window.postAddres.postMessage) {
                postAddres.postMessage(address);
                address = null;
            }
        }
        ...
        if (placeName !== null) {
            if (window.placetitle && window.placetitle.postMessage) {
                placetitle.postMessage(placeName);
                palceName = null;
            }
        }
        ...
        <>
                ...
                <Row style={{ width: '100%', height: '15%', border: '1px solid', borderColor: 'rgb(242,243,245)' }}>
                    <Col style={{ width: '100%', height: '100%' }}>
                        <Row justify={'center'} align={'middle'} style={{ width: '100%', height: '47%', lineHeight: '1px' }}>
                            ...
                            }}>5Makers<b>Map</b></span>
                        </Row>
                        <Row justify={'center'} align={'middle'} style={{ width: '100%', height: '53%' }}>
                            <Input.Search id="keyword" style={{ width: '100%', height: '90%',  borderRadius: '10px', margin: '5px' }} placeholder={'장소,주소 검색'} onSearch={searchFuction}  />
                        </Row>
                    </Col>

                </Row>
                <Row style={{ width: '100%', height: '85%' }} on>
            ...
            <div >
                ...
                <Modal
                    ...
                    onOk={appointOk}
                    onCancel={appointCancel}
                >
                    <span>이 장소를 약속장소로 선택하시겠습니까?</span>
                </Modal>
                <span onClick={zoomIn} style={{ position: 'absolute', top: '20%', right: '5px', border: '1px solid', borderRadius: '50%', padding: '10px', backgroundColor: 'white', borderColor: 'rgb(242,243,245)', color: 'rgb(94,94,94)' }} ><img src="https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/ico_plus.png" alt="확대" width={'15px'} /></span>
                <span onClick={zoomOut} style={{ position: 'absolute', top: '26%', right: '5px', border: '1px solid', borderRadius: '50%', padding: '10px', backgroundColor: 'white', borderColor: 'rgb(242,243,245)', color: 'rgb(94,94,94)' }} ><img src="https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/ico_minus.png" alt="축소" width={'15px'} /></span>
            </div>
